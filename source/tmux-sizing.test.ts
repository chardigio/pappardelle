...
test('list height for 0 sessions = 4', t => {
	t.is(calculateIdealListHeightForCount(0), 4);
});

test('list height for 1 session = 4', t => {
	t.is(calculateIdealListHeightForCount(1), 4);
});

test('list height for 2 sessions = 5', t => {
	t.is(calculateIdealListHeightForCount(2), 5);
});

test('list height for 3 sessions = 6', t => {
	t.is(calculateIdealListHeightForCount(3), 6);
});

test('list height for 4 sessions = 7', t => {
	t.is(calculateIdealListHeightForCount(4), 7);
});

test('list height for 5 sessions = 8', t => {
	t.is(calculateIdealListHeightForCount(5), 8);
});
...
test('vertical 40x15, 1 session', t => {
	// listHeight = 1+3 = 4, claudeHeight = (15-1) - 4 = 10
...
test('vertical 40x20, 2 sessions', t => {
	// listHeight = 2+3 = 5, claudeHeight = (20-1) - 5 = 14
...
test('vertical 60x20, 3 sessions', t => {
	// listHeight = 3+3 = 6, claudeHeight = (20-1) - 6 = 13
...
test('vertical 80x24, 3 sessions', t => {
	// listHeight = 3+3 = 6, claudeHeight = (24-1) - 6 = 17
...
test('vertical 80x24, 5 sessions', t => {
	// listHeight = 5+3 = 8, claudeHeight = (24-1) - 8 = 15
...
test('vertical 80x24, 10 sessions (list capped at 8)', t => {
	// listHeight = 10+3 = 13 → capped at 8, claudeHeight = (24-1) - 8 = 15
...
test('vertical 80x40, 5 sessions (tall terminal)', t => {
	// listHeight = 5+3 = 8, claudeHeight = (40-1) - 8 = 31
...
test('vertical 50x12, 0 sessions (minimal)', t => {
	// listHeight = 0+3 = 4 (min 1), claudeHeight = (12-1) - 4 = 7
...
test('vertical 99x30, 5 sessions (just under threshold)', t => {
	// listHeight = 5+3 = 8, claudeHeight = (30-1) - 8 = 21
...
test('External 27" monitor: 200x60, 8 sessions', t => {
	...
	// list=40 (capped), claude=75, lazygit=83
	assertViewport(
		t,
		layout,
		`
...
test('vertical: session count changes list height', t => {
	...
	t.is(few.listHeight, 5); // 2+3
	t.is(many.listHeight, 8); // 10+3 capped at 8

	t.is(few.claudeHeight, 24); // 29-5
